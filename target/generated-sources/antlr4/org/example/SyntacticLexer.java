...
public class SyntacticLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"READ", "PROGRAM", "FOR", "REPEAT", "WHILE", "IF", "TO", "UNTIL", "DO", 
			"BEGIN", "ELSE", "THEN", "END", "VAR", "INTEGER", "WRITE", "VIRGULA", 
			...
			"SUBTRACAO", "PONTO", "IDENTIFICADOR", "WS", "COMMENT", "LCOMMENT", "A", 
	...
	public SyntacticLexer(CharStream input) {
		super(input);
